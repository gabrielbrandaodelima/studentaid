...
import br.com.ufop.studentaid.core.rateLib.internal.ThemeUtils;

public class StarRatingDrawable extends LayerDrawable {

    public StarRatingDrawable(Context context, boolean fillBackgroundStars) {

        super(new Drawable[]{
                createLayerDrawable(fillBackgroundStars ? R.drawable.ic_star_full
                        : R.drawable.ic_star_empty, fillBackgroundStars ?
                        R.attr.colorControlHighlight : R.attr.colorControlNormal, context),
                fillBackgroundStars ? createClippedTransparentLayerDrawable()
                        : createClippedLayerDrawable(R.drawable.ic_star_full,
